...
public class AdvancedDoors : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (inReach && keyOB.activeInHierarchy && Input.GetButtonDown("Use"))
        {
            unlockedSound.Play();
            locked = false;
        ...
        if (inReach && doorisClosed && unlocked && Input.GetButtonDown("Use"))
        {
        ...
        else if (inReach && doorisOpen && unlocked && Input.GetButtonDown("Use"))
        {
        ...
        if (inReach && locked && Input.GetButtonDown("Use"))
        {
            openText.SetActive(false);
